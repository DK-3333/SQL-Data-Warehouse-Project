...
## Overview
The Gold Layer is the business-level data representation, structured to support analytical and reporting use cases. It consists of **fact tables** and **dimension tables** for specific business metrics.
...
| country          | VARCHAR(50)   | The country of residence for the customer (e.g., 'Germany').                               |
